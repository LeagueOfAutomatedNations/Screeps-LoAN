...
class Rankings(object):
    ...
    def run(self):
        ...
        for alliance in all_alliances:
            ...
            print('%s- %s, %s, %s, %s, %s, %s, %s' % (
                alliance['shortname'], combined_gcl, alliance_gcl, rcl, spawns, len(filtered_members), alliance_power,
                combined_power))

            self.update(alliance['shortname'], alliance_gcl, combined_gcl, rcl, spawns, len(filtered_members),
                        alliance_power, combined_power)
    ...
    def update(self, alliance, alliance_gcl, combined_gcl, rcl, spawns, members, alliance_power, combined_power):
        ...
        cursor.execute(query, (
            self.id, alliance, alliance_gcl, combined_gcl, rcl, spawns, members, alliance_power, combined_power))
